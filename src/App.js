...
const App = () => {
  ...
  return (
    <div className="App">
      ...
      <Suspense fallback={<ClockSpinner />}>
        <Router>
          <Switch>
            ...
            <Route exact path="/djehuiroq8igbh8qpinurf839e" component={() => <h1>Created by Richard M. GUERRE</h1>} />
      ...
      {/* Temporary FIXME */}
      <a
        href="https://www.surveymonkey.com/r/8JNNY62"
        target="_blank"
        ...
        style={{
          ...
          border: "none",
          background: "linear-gradient(100deg, #ffae34 0%, #f95584 100%)",
        }}
      >
        Give Feedback
      </a>
