...
const TermsPage = () => {
  document.title = "Launger - Terms & Conditions";

  return (
    <>
      <NavBar />
      <div className="TermsPage container page-content">
        <section className="terms">
          ...
          <ul>
            <li>
              ...
              means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other
              managing authority.
            </li>
            <li>
              <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Launger.
            </li>
            <li>
            ...
            <li>
              <strong>Terms of service</strong> (also referred as "Terms") mean these Terms of service that form the entire agreement between You and
              the Company regarding the use of the Service. This Terms of service agreement as been created with the help of{" "}
              <a href="https://www.termsfeed.com/terms-conditions-generator/">Terms of service Generator</a>.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Launger, accessible from https://launger.web.app
            </li>{" "}
            <li>
          ...
          <p>
            These are the Terms of service governing the use of this Service and the agreement that operates between You and the Company. These Terms
            of service set out the rights and obligations of all users regarding the use of the Service.
          </p>
          <p>
            Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms of service. These Terms of
            service apply to all visitors, users and others who access or use the Service.
          </p>
          <p>
            By accessing or using the Service You agree to be bound by these Terms of service. If You disagree with any part of these Terms and
          ...
          <p>
            ...
            Application or the Website and tells You about Your privacy rights and how the law protects You. Please read Our Privacy Policy carefully
          ...
          <p>
            ...
            Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 100
          ...
          <p>
            ...
            inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection with any
            provision of this Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if the remedy
          ...
          <p>
            ...
            Service, including all implied warranties of merchantability, fitness for a particular purpose, title and non-infringement, and warranties
            that may arise out of course of dealing, course of performance, usage or trade practice. Without limitation to the foregoing, the Company
            provides no warranty or undertaking, and makes no representation of any kind that the Service will meet Your requirements, achieve any
            intended results, be compatible or work with any other software, applications, systems or services, operate without interruption, meet any
          ...
          <p>
            ...
            information or content provided through the Service; or (iv) that the Service, its servers, the content, or e-mails sent from or on behalf
            of the Company are free of viruses, scripts, trojan horses, worms, malware, timebombs or other harmful components.
          </p>
          <p>
          ...
          <ul>
            <li>By email: contact@launger.com</li>
            <li>
              By visiting: <a href="/contact-us">https://launger.web.app/contact-us</a>
            </li>
          </ul>
        </section>
      </div>
