  ...
  return (
    <>
      ...
      <div className="PrivacyPage container page-content">
        ...
        <ul>
          <li>Email address</li>
          <li>First name and last name (Only when signed up with Google)</li>{" "}
          <li>Usage Data</li>
        </ul>
        ...
        <ul>
          <li>
            ...
            <p>
              You can prevent Google Analytics from using your information for analytics
              purposes by opting-out using Launger.
            </p>
            <p>
              For more information on what type of information Google Analytics collects,
              please visit the Terms of Service page of Google Analytics:{" "}
