...
const Card = ({ alreadyGot }) => {
  const id = "2e974F8BDBfa97dDcF12E7525b174C99",
    name = config[id].name,
    thumbnails = {
      bg: (
        <div className="reddit-card-bg">
          <div className="text">
            <div className="name" style={{ fontSize: "1.7em" }}>
              {name}
            </div>
      ...
      fg: (
        <>
          <img style={{ position: "relative", width: "100%" }} src="https://i.redd.it/iwnu8apxfur01.png" alt="Meme illustration" />
          <h1
            style={{
              fontSize: "1.7em",
              color: "white",
